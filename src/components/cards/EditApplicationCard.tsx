      ...
      const id = toast.info(
        <div>
          ...
          <div className="flex items-center justify-evenly">
            <button className="bg-button2 text-white" onClick={handleConfirm}>
              Yes
            </button>
            <button className="bg-button1 text-white" onClick={handleCancel}>
              No
            </button>
          </div>
        </div>,
        {
          ...
          // closeButton: false,
          onClose: () => {
            setIsDisabled(false), setToastId(null);
          },
        }
      );
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="flex flex-col w-64">
                ...
                {errors.application_info && (
                  <p className="text-red-500 text-xs">
                    {errors.application_info.message}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="flex justify-center pt-5">
              {toastId ? (
                <>
                  ...
                  <button
                    disabled
                    className="bg-button3 text-mainbody px-6 py-2 rounded-md w-40 text-center mb-10 mx-4"
                  >
                    Cancel
                  </button>
                </>
