...
const Navbar = () => {
    ...
    const fetchGuestId = async () => {
        try {
          const fetchedGuestId = await axios.get(`http://localhost:3000/api/users/guest`);
    ...
    const fetchUserInfo = async () => {
        try {
          ...
          const fetchedUserInfo = await axios.get(`http://localhost:3000/api/users/${userParam}`);
...
return (
    <div>applications, companies applied to, contacts</div>
